...
$lang->menu->slide          = '轮播图|slide|admin|';
...
$lang->security->menu->actions     = '操作日志|action|admin|';
...
$lang->action->browse = '前后台动态';
$lang->action->admin  = '操作日志';
...
$lang->action->indexDesc->login             = '$actor 登录系统';
...
$lang->action->label->edited            = '编辑';
$lang->action->label->finished          = '完成';
$lang->action->label->canceled          = '取消';
$lang->action->label->deleted           = '删除';
$lang->action->label->login             = '登录';
$lang->action->label->space             = '　';

$lang->action->typeList = new stdclass();
$lang->action->typeList->all     = '全部类型';
$lang->action->typeList->article = '文章';
$lang->action->typeList->page    = '单页';
$lang->action->typeList->blog    = '博客';
$lang->action->typeList->video   = '视频';
$lang->action->typeList->tree    = '类目';
$lang->action->typeList->site    = '站点';
$lang->action->typeList->user    = '会员';
$lang->action->typeList->order   = '订单';
/* address */
...
$lang->file->noCategoryFile = '未分类素材';
...
$lang->product->saveAndPreview = '保存并预览';
...
$lang->site->modules          = '功能模块';
$lang->site->lang             = '站点语言';
$lang->site->enabledLangs     = '站点语言';
...
$lang->site->autoLogin         = '自动登录';
$lang->site->verification      = '网站验证';
...
$lang->site->action->qqOauth          = 'QQ登陆接口';
$lang->site->action->wechatOauth      = '微信登陆接口';
$lang->site->action->githubOauth      = 'Github登陆接口';
$lang->site->action->facebookOauth    = 'Facebook登陆接口';
$lang->site->action->sinaOauth        = '新浪登陆接口';
$lang->site->action->contentSensitive = '内容敏感词';
$lang->site->action->userSensitive    = '用户敏感词';
