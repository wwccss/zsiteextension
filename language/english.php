...
$lang->menu->article  = 'Articles|article|admin|type=article';
$lang->menu->blog     = 'Blogs|article|admin|type=blog';
$lang->menu->book     = 'Books|book|admin|';
$lang->menu->page     = 'Pages|article|admin|type=page';

$lang->menu->order        = 'Order|order|admin|';
$lang->menu->product      = 'Product|product|admin|';
$lang->menu->orderSetting = 'Settings|product|setting|';

$lang->menu->user         = 'Users|user|admin|';
$lang->menu->message      = 'Messages|message|admin|type=message';
$lang->menu->comment      = 'Comments|message|admin|type=comment';
$lang->menu->reply        = 'Replies|message|admin|type=reply';
$lang->menu->forum        = 'Forum|forum|admin|';
$lang->menu->thread       = 'Threads|forum|admin|';
...
$lang->menu->site     = 'Sites|site|setbasic|';
...
$lang->product->menu->browse = array('link' => 'Products|product|admin|', 'alias' => 'create, edit');
...
$lang->security->menu->log       = 'Logs|user|adminlog|';
...
$lang->admin->ignore        = 'Ignore security warnings';
$lang->admin->ignoreupgrade = 'Ignore upgrade prompts';
...
$lang->article->copySite   = 'Copy Site';
...
$lang->submittion->typeList['article'] = 'Articles';
$lang->submittion->typeList['blog']    = 'Blogs';
...
$lang->article->noSubmittion   = 'You have no contribution yet. Contribute and earn points now!';
...
$lang->block->regionList      = 'Regions';
$lang->block->select          = 'Select a Block';
$lang->block->categories      = 'Categories';
$lang->block->showImage       = 'Display Images';
$lang->block->maxWidth        = 'Max Width ';
$lang->block->showCategory    = 'Display Categories';
$lang->block->showBoard       = 'Display Boards';
...
$lang->block->add          = "Add";
$lang->block->addChild     = "Children";
$lang->block->template     = "Template";
$lang->block->create       = 'Add a Block';
$lang->block->browseBlocks = 'Blocks';
...
$lang->block->sideGrid  = 'Sidebar Grid';
$lang->block->sideFloat = 'Sidebar Float';
/* blog */
...
$lang->book->goHome   = 'Back to Home';

$lang->book->aliasRepeat   = 'Alias <strong> %s </strong> cannot be added again.';
$lang->book->confirmDelete = "<span class='text-danger'>You will delete all chapters and articles in this book. Do you want to delete it?</span>";

$lang->book->note = new stdclass();
$lang->book->note->addedDate = 'You can schedule the date to publish.';
/* cart */
...
$lang->error->searchTip       = 'Please continue browsing our website. You can use Search.';
/* file */
$lang->file->common        = 'Files';
$lang->file->upload        = 'Upload';
$lang->file->browse        = 'Files';
$lang->file->imageList     = 'Images';
...
$lang->file->public    = 'Public Download';
...
$lang->file->confirm   = 'It costs you %s points to download this extension.';
...
$lang->file->fileManager = 'Manange Files';
...
$lang->forum->board       = 'Boards';
$lang->forum->owners      = 'Moderators';
...
$lang->forum->admin   = 'Manage';
$lang->forum->update  = 'Data Update';
$lang->forum->setting = 'Forum Settings';
$lang->forum->postReview = 'Review';

$lang->forum->updateDesc    = 'Data update will update post counts on each board.';
...
$lang->guarder->action       = 'Actions';
$lang->guarder->then         = 'Then';
$lang->guarder->setBlacklist = 'Blacklists';
$lang->guarder->setWhitelist = 'Whitelists';
...
$lang->guarder->question       = 'Questions';
$lang->guarder->answer         = 'Answers';
...
$lang->guarder->blacklistModes['guard']    = 'Websites';
...
$lang->message->showDetail        = 'Details';
$lang->message->hideDetail        = 'Hide';

$lang->message->admin          = 'Admin';
...
$lang->misc->thanksTitle      = 'Changer is built refering to outstanding open source projects.';
...
$lang->nav->addChild = 'Add Children';
...
$lang->nav->types['custom']  = 'Customizations';

$lang->nav->system = new stdclass();
$lang->nav->system->home    = 'Home';
$lang->nav->system->company = 'About Us';
$lang->nav->system->contact = 'Contact Us';
$lang->nav->system->forum   = 'Forums';
$lang->nav->system->blog    = 'Blogs';
$lang->nav->system->book    = 'Books';
$lang->nav->system->message = 'Messages';
...
$lang->order->express        = 'Shipment Carrier';
...
$lang->order->paymentList['offlinepay']    = 'Pay Offline';
...
$lang->package->code        = 'Extension ID';
$lang->package->version     = 'Version';
$lang->package->compatible  = 'Compatible Version';
...
$lang->package->updatedTime = 'Last Updated on';
...
$lang->package->confirmUninstall         = 'Uninstal this extension will delete/modify related database. Do you want to uninstal it?';
$lang->package->noticeBackupDB           = 'Please back up your databse before uninstal!';
$lang->package->installFinished          = 'The extension is %sed!';
$lang->package->refreshPage              = 'Refresh';
$lang->package->uninstallFinished        = 'Extension has been unistalled.';
$lang->package->deactivateFinished       = 'Extension has been deactivated.';
$lang->package->activateFinished         = 'Extension has been activated.';
$lang->package->eraseFinished            = 'Extension has been ereased.';
...
$lang->package->successDownloadedPackage = 'Extension is downloaded.';
$lang->package->successUploadedPackage   = 'Extension is uploaded.';
...
$lang->package->backDBFile               = 'Extension relavant data has been backed up to %s ！';
...
$lang->package->types->theme     = 'Themes';
...
$lang->package->errorGetPackages             = 'Get extensions from www.chanzhi.org failed. Please check your network, and go to <a href="http://www.chanzhi.org/extemsion" target="_blank" class="alert-link">www.chanzhi.org</a> to manually download plug-ins to install.';
...
$lang->package->errorIncompatible            = 'This extension is incompatible with Changer.';
$lang->package->errorUninstallDepends        = '“%s” is dependent on this extension. Do not uninstall it.';

$lang->theme->common = 'Themes';
/* product */
...
$lang->product->stick      = 'Sticky Type';
$lang->product->order      = 'Ordinal';
$lang->product->unsaleable = 'Not for Sale';
$lang->product->attribute  = 'Attribution';
$lang->product->custom     = 'Customization';
...
$lang->reply->admin     = 'Manage';
$lang->reply->sofa      = '1st Reply';
$lang->reply->stool     = '2nd Reply';

$lang->reply->edit       = 'Edit';
$lang->reply->deleteFile = 'Delete';
/* score */
...
$lang->score->buyWaring   = "Minimun refill is %s Yuan，1 Yuan=%s Points";
$lang->score->errorAmount = "Refill amount should be more than %s Yuan.";
$lang->score->alipay      = "Use AliPay";
...
$lang->site->checkLocation    = 'Login Verification';
...
$lang->site->setsensitive     = 'Sensitive Words Settings';
$lang->site->filterSensitive  = 'Sensitive Words Filter';
...
$lang->site->setOauth      = "Social Login";
...
$lang->site->captchaList['open']  = 'On';
$lang->site->captchaList['auto']  = 'Auto';
$lang->site->captchaList['close'] = 'Off';
...
$lang->site->moduleAvailable['user']       = 'Users';
$lang->site->moduleAvailable['article']    = 'Articles';
$lang->site->moduleAvailable['blog']       = 'Blogs';
$lang->site->moduleAvailable['product']    = 'Products';
$lang->site->moduleAvailable['book']       = 'Books';
$lang->site->moduleAvailable['page']       = 'Pages';
$lang->site->moduleAvailable['forum']      = 'Forum';
$lang->site->moduleAvailable['message']    = 'Messages';
...
$lang->site->domainTip        = 'All visits will be directed to this domain. Please make sure the domain analysis is correct. Leave it empty if no redirection is wanted.';
...
$lang->site->schemeTip        = 'All visits will be redirected to default access protocol.';
...
$lang->site->menus['order']      = 'Orders';
$lang->site->menus['message']    = 'Messages';
$lang->site->menus['comment']    = 'Comments';
$lang->site->menus['reply']      = 'Replies';
$lang->site->menus['thread']     = 'Themes';
$lang->site->menus['forumreply'] = 'Reply';
$lang->site->menus['article']    = 'Articles';
$lang->site->menus['page']       = 'Pages';
$lang->site->menus['blog']       = 'Blogs';
$lang->site->menus['book']       = 'Books';
$lang->site->menus['submittion'] = 'Contribute';
$lang->site->menus['product']    = 'Products';
$lang->site->menus['user']       = 'Users';
$lang->site->menus['wechat']     = 'Wechat';
$lang->site->menus['stat']       = 'Statistics';
$lang->site->menus['tag']        = 'Keywords';
$lang->site->menus['links']      = 'Links';
$lang->site->menus['site']       = 'Sites';
$lang->site->menus['security']   = 'Security';
/* sitemap */
$lang->sitemap->productCategory = 'Product Categories';
$lang->sitemap->articleCategory = 'Article Categories';
$lang->sitemap->blogCategory    = 'Blog Categories';
...
$lang->slide->group      = 'Categories';
$lang->slide->title      = 'Title';
$lang->slide->groupName  = 'Group Name';
$lang->slide->titleColor = 'Title Name';
$lang->slide->image      = 'Images';
$lang->slide->mainLink   = 'Links';
$lang->slide->summary    = 'Summary';
$lang->slide->label      = 'Labels';
$lang->slide->button     = 'Buttons';
...
$lang->slide->successSort     = 'Sorting is saved!';
$lang->slide->noImageSelected = 'Choose an Image';
$lang->slide->suitableSize    = 'Image sizees should be the same.';
...
$lang->stat->report        = 'Reports';
$lang->stat->client        = 'Clients';
...
$lang->stat->keywordReport = 'Keywords Stats';
...
$lang->stat->keywordNotice = 'Google and Bidu has deactivated keyword display of source links, so keywords statistics is not available.';

$lang->stat->all   = 'All';
$lang->stat->begin = 'Start';
$lang->stat->end   = 'End';
$lang->stat->date  = 'Date';
...
$lang->tag->sourceList['article']  = 'Articles';
$lang->tag->sourceList['blog']     = 'Blogs';
$lang->tag->sourceList['page']     = 'Pages';
$lang->tag->sourceList['product']  = 'Products';
$lang->tag->sourceList['book']     = 'Books';
$lang->tag->sourceList['category'] = 'Categories';
$lang->tag->sourceList['board']    = 'Boards';
/* thread */
$lang->thread->common    = 'Themes';
...
$lang->thread->edit           = 'Edit a Thread';
...
$lang->thread->successUnstick  = 'Sticky cancelled!';
...
$lang->tree->browse      = "View;
$lang->tree->manage      = "Manage";
$lang->tree->fix         = "Fix Data";
$lang->tree->children    = "Children";
$lang->tree->layout      = 'Layout';

$lang->tree->common           = 'Categories';
$lang->tree->noCategories     = 'Please create a category.';
$lang->tree->timeCountDown    = "<strong id='countDown'>3</strong> seconds later, it will be redirected to Categories page.";
$lang->tree->redirect         = 'Redirecting Now';
...
$lang->tree->hasChildren      = 'This board belongs to a child board. Do not delete it.';
...
$lang->board->placeholder->setChildren = 'Set secondary boards to display a forum.';
...
$lang->wechatMenu->setResponse = 'Settings';
/* ui */
$lang->ui->common = "UI";
...
$lang->ui->manageTheme     = 'Manage Themes';
...
$lang->ui->templateName    = "Templates";
...
$lang->ui->setLogoFailed          = "Settins logos failed.";
...
$lang->ui->template->currentTheme    = '<strong>%s</strong> in use';
...
$lang->ui->template->manageTemplate  = 'Manage a Template';
$lang->ui->template->manageBlock     = 'Manage a Block';
...
$lang->ui->linkColor       = 'Color';
$lang->ui->linkFontSize    = 'Font';
...
$lang->ui->files->default->block['featuredproduct'] = 'Featured Products';
...
$lang->ui->files->default->block['nav']             = 'Navigation Bars';
...
$lang->ui->files->default->article['browse'] = 'Articles';
$lang->ui->files->default->article['view']   = 'Details';

$lang->ui->files->default->article['blog/header'] = 'Header';
$lang->ui->files->default->article['blog/index']  = 'Blogs';
$lang->ui->files->default->article['blog/view']   = 'Details';
$lang->ui->files->default->article['blog/footer'] = 'Bottom';
...
$lang->ui->files->default->product['view']        = 'Details';

$lang->ui->files->default->forum = array();
$lang->ui->files->default->forum['index'] = 'Home';
$lang->ui->files->default->forum['board'] = 'Boards';
...
$lang->ui->files->default->forum['reply/reply']   = 'Replies';
...
$lang->ui->files->default->message['index']       = 'Home';
...
$lang->user->submittion  = 'My Contributions';

$lang->user->userHistory       = "User History";
$lang->user->threadHistory     = "Posts";
$lang->user->replyHistory      = "Replies";
$lang->user->commentHistory    = "Comments";
$lang->user->messageHistory    = "Messages";
$lang->user->orderHistory      = "Orders";
$lang->user->addressHistory    = "Address`";
$lang->user->submittionHistory = "Contributions";
...
$lang->user->login->welcome = 'Existed Account';
...
$lang->user->resetMail->resetUrl = 'You have requested to reset your password at %s（%s）. Pleae click the link belwo and reset your password.'; 
$lang->user->resetMail->notice   = 'This is automatically set by the sysytem. Please do not reply.(Ignore this Email, if you did not want to reset it.)';

$lang->user->oauth = new stdclass();
$lang->user->oauth->common       = 'Social Login';
...
$lang->user->oauth->lblWelcome       = 'Social Login';
$lang->user->oauth->lblOtherLogin    = 'Other';
$lang->user->oauth->lblProfile       = "Register";
...
$lang->user->oauth->lblUnbindFailed  = "Remove binding failed!";
...
$lang->user->control->lblPassword = "If leave empty, nothing is changed.";

$lang->user->navGroups = new stdclass();
$lang->user->navGroups->user    = 'My Profile';
$lang->user->navGroups->order   = 'My Orders';
...
$lang->user->log->common = 'Logs';
$lang->user->log->list   = 'Login Logs';

$lang->user->log->id          = 'ID';
$lang->user->log->account     = 'Account';
$lang->user->log->browser     = 'View';
$lang->user->log->ip          = 'IP';
...
$lang->visual->js->carousel          = 'Slides';
$lang->visual->js->operateFail       = 'Action failed！';
$lang->visual->js->addContent        = 'Adding...';
$lang->visual->js->addContentTo      = 'Add content to 【{0}】';
$lang->visual->js->createBlock       = 'Create a Block';
$lang->visual->js->addSubRegion      = 'Add a Child';
$lang->visual->js->addBlock          = 'Add an existing Block';
$lang->visual->js->subRegion         = 'Children';
$lang->visual->js->subRegionDesc     = 'Details';
...
$lang->wechat->appID     = 'App ID';
$lang->wechat->appSecret = 'App Secret';
...
$lang->wechat->response->link     = 'Links';
$lang->wechat->response->category = 'Categories';
$lang->wechat->response->limit    = 'Count';

$lang->wechat->response->list   = 'Lists';

$lang->wechat->response->typeList['link'] = 'Links';
$lang->wechat->response->typeList['text'] = 'Text';
$lang->wechat->response->typeList['news'] = 'Images';

$lang->wechat->response->sourceList['system'] = "System";
$lang->wechat->response->sourceList['manual'] = 'Book';

$lang->wechat->response->moduleList['index']   = 'Home';
$lang->wechat->response->moduleList['company'] = 'About Us';
$lang->wechat->response->moduleList['blog']    = 'Blogs';
$lang->wechat->response->moduleList['forum']   = 'Forum';
$lang->wechat->response->moduleList['book']    = 'Books';
...
$lang->wechat->response->newsBlockList['articleTree']   = 'Article Categories';
$lang->wechat->response->newsBlockList['latestArticle'] = 'Latest Articles';
$lang->wechat->response->newsBlockList['hotArticle']    = 'Hot Articles';
$lang->wechat->response->newsBlockList['productTree']   = 'Product Categories';
$lang->wechat->response->newsBlockList['latestProduct'] = 'Latest Products';
$lang->wechat->response->newsBlockList['hotProduct']    = 'Hot Products';
...
$lang->wechat->message->typeList['click']       = 'Clicks';
$lang->wechat->message->typeList['view']        = 'Links';
...
$lang->widget->message = 'Messages';
$lang->widget->comment = 'Comments';
$lang->widget->reply   = 'Replies';

$lang->widget->create    = 'Add a Widget';
$lang->widget->hidden    = 'Hide';
$lang->widget->lblWidget = 'Widget';
...
$lang->widget->default['1']['type']  = 'Latest Order';
$lang->widget->default['1']['grid']  = 4;

$lang->widget->default['2']['title'] = 'Latest Thread';
$lang->widget->default['2']['type']  = 'Latest Thread';
...
$lang->widget->typeList->html           = 'Customization';
